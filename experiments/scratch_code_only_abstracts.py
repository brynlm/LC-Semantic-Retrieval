...
def scrub_leaks(mechanism: str, leaked_words: list[str]) -> str:
    ...
    for model in MODEL_CHAIN:
        ...
        for attempt in range(2):
            ...
            if not leaks(abstract["mechanism"]):
                return abstract
            # Scrub didn't fully clear it (e.g. a banned word embedded in a
            # way the regex missed) -- fall through to an actual retry as
            # the last resort.
    return None
